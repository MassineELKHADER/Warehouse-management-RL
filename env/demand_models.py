"""
Stochastic demand models for the warehouse environment.

Each model is a callable that receives (n_warehouses, rng) and returns
a demand vector of shape (N,).
"""
...
class PoissonDemand:
    """Independent Poisson demand at each warehouse."""
...
class GaussianDemand:
    """Independent Gaussian demand (clipped to non-negative)."""
...
class SeasonalDemand:
    """
    Demand oscillates sinusoidally around a mean with additive Poisson noise.
    Useful for testing how well agents adapt to non-stationary demand.
    """
